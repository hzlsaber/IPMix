...
parser.add_argument('--imagenet-a-dir', help='Path to ImageNet-A', default="data/imagenet_a/")
...
parser.add_argument('--batch-size-val', default=512, type=int)
...
# ImageNet-A classes
##################################################
imagenet_a_wnids = ['n03355925', 'n03255030', 'n02504458', 'n01847000', 'n01910747', 'n02037110', 'n12144580',
                    'n03388043', 'n01531178', 'n02883205', 'n04131690', 'n07697313', 'n02951358', 'n02190166',
                    'n04456115', 'n03840681', 'n04347754', 'n04310018', 'n02980441', 'n04208210', 'n02259212',
                    'n01580077', 'n04086273', 'n01774750', 'n03014705', 'n02701002', 'n03888257', 'n02174001',
                    'n02895154', 'n04606251', 'n03721384', 'n02280649', 'n02051845', 'n03891332', 'n03384352',
                    'n02177972', 'n07753592', 'n02281787', 'n04235860', 'n03584829', 'n02233338', 'n04146614',
                    'n12057211', 'n02007558', 'n02356798', 'n03250847', 'n04033901', 'n01698640', 'n02129165',
                    'n07831146', 'n07714990', 'n02690373', 'n03026506', 'n02085620', 'n04141076', 'n04509417',
                    'n03444034', 'n02325366', 'n01694178', 'n03854065', 'n04344873', 'n03617480', 'n04389033',
                    'n02793495', 'n02279972', 'n03788195', 'n01843383', 'n02730930', 'n04366367', 'n04118538',
                    'n02317335', 'n02165456', 'n02133161', 'n04591713', 'n04019541', 'n07749582', 'n04067472',
                    'n01944390', 'n02879718', 'n02486410', 'n03452741', 'n01498041', 'n01784675', 'n04317175',
                    'n02906734', 'n02106550', 'n01677366', 'n01986214', 'n02948072', 'n02672831', 'n01820546',
                    'n03804744', 'n03717622', 'n02454379', 'n07718472', 'n04507155', 'n01882714', 'n03724870',
                    'n01833805', 'n04275548', 'n04252225', 'n02802426', 'n04133789', 'n03935335', 'n03590841',
                    'n01914609', 'n03124043', 'n04099969', 'n04179913', 'n02119022', 'n07697537', 'n01735189',
                    'n04254120', 'n02676566', 'n02127052', 'n01687978', 'n03666591', 'n01770393', 'n02814860',
                    'n02077923', 'n04270147', 'n02236044', 'n01819313', 'n04355338', 'n02206856', 'n01534433',
                    'n04376876', 'n04147183', 'n04532670', 'n02777292', 'n02445715', 'n01631663', 'n04039381',
                    'n04540053', 'n03837869', 'n03187595', 'n04482393', 'n02106662', 'n01924916', 'n02782093',
                    'n03125729', 'n02669723', 'n02655020', 'n07760859', 'n02231487', 'n02837789', 'n02009912',
                    'n12267677', 'n09229709', 'n02346627', 'n01558993', 'n03982430', 'n02992211', 'n02797295',
                    'n02361337', 'n04252077', 'n03291819', 'n01641577', 'n01669191', 'n01614925', 'n02410509',
                    'n02123394', 'n07583066', 'n03720891', 'n02110958', 'n01855672', 'n07734744', 'n03594945',
                    'n02787622', 'n02999410', 'n09472597', 'n03775071', 'n02268443', 'n04399382', 'n07768694',
                    'n02492035', 'n11879895', 'n03445924', 'n07695742', 'n03443371', 'n09835506', 'n03325584',
                    'n03670208', 'n04442312', 'n01770081', 'n02815834', 'n02226429', 'n02219486', 'n03417042',
                    'n03196217', 'n04554684', 'n04562935', 'n01985128', 'n02099601', 'n09246464', 'n07720875',
                    'n03223299', 'n01616318', 'n03483316', 'n02137549']
        ...
        if mixing_ways == 'P':
            for _ in range(np.random.randint(args.t + 1)):
                ...
                if random.random() > 0.5:
                    ...
                    mixed_copy = augment_input(image)
                    mixed = patch_mixing(mixed, mixed_copy, patch_size, mix_op, args.beta)
        else:
            for _ in range(np.random.randint(args.t + 1)):
...
def main():
    ...
    train_dataset = IPMixDataset(train_data, mixing_set, preprocess, args.no_jsd)
    ...
    scheduler = torch.optim.lr_scheduler.LambdaLR(
        ...
        lr_lambda=lambda step: cosine_annealing(
            ...
            1e-6 / (args.lr * args.batch_size / 128.)))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        # train for one epoch
        train_losses_avg, train_top1_avg, train_top5_avg = train(train_loader, model, criterion, optimizer, scheduler,
                                                                 epoch, args)

        print("Evaluating on validation set")
        val_losses_avg, val_top1_avg, val_top5_avg = validate(val_loader, model, criterion, args)

        val_R_losses_avg, val_R_top1_avg, val_R_top5_avg = validate(val_loader_imagenet_r, model, criterion, args,
                                                                    r=True)
...
def evaluate_c(model, normalize, args):
    ...
    corruptions = [e for e in os.listdir(args.data_path) if
                   os.path.isdir(os.path.join(args.data_path, e))]  # All subdirectories, ignoring normal files
